...
const wrapper: React.FC = ({ children }) => <MyContext.Provider value="world">{children}</MyContext.Provider>;

const TestAngularOne = reactular(TestOne, ['foo', 'bar', 'baz'])
const TestAngularTwo = reactular(TestTwo, ['foo', 'bar', 'baz'])
...
const TestAngularEight = reactular(TestEight, ['values', 'onComponentWillUnmount', 'onRender', 'onChange'])
